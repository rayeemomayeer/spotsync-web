    ...
    return [
      {
        ...
        items: [
          ...
          { href: "/org/observe", label: "Observe", description: "Org capacity + health" },
    ...
    return [
      {
        ...
        items: [
          ...
          { href: "/platform/users", label: "Users", description: "Better Auth accounts" },
          { href: "/platform/zones", label: "Zones", description: "Inventory" },
          { href: "/platform/observe", label: "Observe", description: "Health + metrics" },
